...
namespace ConsoleApp2
{
    public class MoveAnimation : Animation
    {
        ...
        public MoveAnimation(Vector2D positionOfFirst, Transformable[] transformables, double duration, double timeOfStart, Vector2D positionOfEnd)
        {
        ...
        public MoveAnimation(Vector2D positionOfFirst, Transformable[] objects, double duration, double timeOfStart, bool isStartPosition)
        {
            if (!Program.playAnimations)
                return;
