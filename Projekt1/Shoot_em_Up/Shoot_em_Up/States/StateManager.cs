...
namespace ConsoleApp2
{
    public class StateManager
    {
        ...
        public StateManager(List<State> states, List<GameObject> players)
        {
            _states = states;
            _players = players;
        ...
        public List<GameObject> Players { get => _players; set { _players = value; _stateActive = new double[_states.Count, _players.Count]; } }

        public void AddState(GameObject player, State state, double duration)
        {
