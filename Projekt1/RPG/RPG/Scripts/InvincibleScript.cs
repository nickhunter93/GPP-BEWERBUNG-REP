...
{
    public class InvincibleScript : Script, IRegisterEvent
    {
        ...
        {
            if (sound == "roll")
                Play?.Invoke(this, new SoundsEventArgs(SoundManager.SoundNumbers.Roll));
        }
        ...
        public override void Update(double elapsedTime)
        {
            ...
            if (IsInvincible)
            {
                _parent.GetComponent<RenderComponent>().Sprite.Scale = Vector2D.One() * 0.8f;
            ...
            {
                _parent.GetComponent<RenderComponent>().Sprite.Scale = Vector2D.One() * 1;
