...
{
    public class MainMenu: IRegisterEvent
    {
        ...
        private Text _exit;
        private PlayerSettingsGui _playerSettingsGui;
        ...
        private void Initialise()
        {
            ...
            _playerSettingsGui = new PlayerSettingsGui(new Vector2D(Program.windowSize.X / 2 - 300, Program.windowSize.Y / 2 - 150), _font);
            
            _animationManager.AddAnimation(new MoveAnimation(new Vector2D(-_rectangleLeft.Size.X / 2 - _rectangleLeft.OutlineThickness, Program.windowSize.Y / 2), new Transformable[] { _rectangleLeft, _playerSettingsGui }, 1000, 0, true));
        ...
        private void Input()
        {
            ...
            if (Mouse.IsButtonPressed(Mouse.Button.Left))
            {
                ...
                if (!_isMousePressed)
                {
                    ...
                    _playerSettingsGui.TouchedOnce(mousePosition);
        ...
        private void Update(double elapsedTime)
        {
            ...
            _settingsGui.Update(elapsedTime);
        ...
        private void Redraw()
        {
            ...
            _window.Draw(_playerSettingsGui);
        ...
        public bool IsEasy()
        {
            return _playerSettingsGui.IsEasy();
        }

        public int GetPlayerCount()
        {
            return _playerSettingsGui.GetPlayerCount();
        }

        public void PlayerSet()
        {
            _playerSettingsGui.PlayerSet();
        }
